...
//import img from "../../../../../../public/media/client-logos/logo1.png";
...
export function UserProfileDropdown() {
  ...
  //   //   getAvatar(user._id).then((response)=>( 
          ...
          {!layoutProps.light && (
            ...
            >
              <div className="symbol bg-white-o-15 mr-3">
                ...
                <img alt="Pic" className="hidden" src={user.avatar?user.avatar:toAbsoluteUrl("/media/users/default.jpg")} />
              </div>
