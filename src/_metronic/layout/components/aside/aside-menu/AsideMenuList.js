    ...
    <>
      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
        ...
        <li
                ...
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/Bateaux">
                  
                  <span className="svg-icon menu-icon">
                   <SVG src={toAbsoluteUrl("/media/svg/icons/Design/Layers.svg")} />
                 </span>
                  <span className="menu-text">Mes Bateaux</span>
                </NavLink>
        </li>
        {/*begin::2 Level*/}
        <li
              ...
              >
                <NavLink className="menu-link" to="/e-commerce/products">
                  ...
                  <span className="menu-text">Mes traveaux</span>
                </NavLink>
              </li>
              {/*end::2 Level*/}
              {/*end::2 Level*/}
        ...
        >
          <NavLink className="menu-link" to="/user-profile">
            ...
            <span className="menu-text">Mon profile</span>
          </NavLink>
        </li>
        {/*end::1 Level*/}
        <li
