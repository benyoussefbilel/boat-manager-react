...
function PersonaInformation(props) {
  ...
  const initialValues = {
    ...
    phone: user.phone,
    email: user.email,
    adresseProvince:user.adresseProvince,
    adresseCity:user.adresseCity,
  ...
  const Schema = Yup.object().shape({
    ...
    website: Yup.string(),
    adresseProvince:Yup.string().required("Province is required"),
    adresseCity:Yup.string().required("City is required"),
    adresseCodePostal:Yup.number().required("Code Postal is required"),
    adressePays:Yup.string().required("Pays is required")
  });
